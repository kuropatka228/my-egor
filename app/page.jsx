    ...
    return (  
        <div className="grid items-center justify-items-center min-h-screen pb-20 font-[family-name:var(--font-geist-sans)]">   
            ...
            <div className="flex flex-col h-[560px]"> 
                <div className="flex flex-col md:flex-row justify-between mb-10 gap-x-28">  
                    ...
                    <div className="flex-shrink-0">   
                        <Image src='/list.png' width={540} height={560} alt="Описание изображения" className="max-w-full h-auto"/>        
                    </div>  
                </div> 
            </div> 

            <div className="w-full bg-gray-200 p-10 pl-4 pr-4 md:pl-36 md:pr-36">
                <div className="flex flex-col md:flex-row justify-between">  
                    <div className="flex items-center mb-4 md:mb-0">  
                        <Image src='/image1.png' width={150} height={150} alt="Картинка 1" className="max-w-full h-auto"/>  
                        <div className="ml-4">  
                    ...
                    <div className="flex items-center mb-4 md:mb-0">  
                        <Image src='/image2.png' width={150} height={150} alt="Картинка 2" className="max-w-full h-auto"/>  
                        <div className="ml-4">  
                    ...
                    <div className="flex items-center">  
                        <Image src='/image3.png' width={150} height={150} alt="Картинка 3" className="max-w-full h-auto"/>  
                        <div className="ml-4">  
                ...
                <div className="flex mt-10">
                    <div className="w-full md:w-1/2">
                        <Image src='/large-image.png' width={730} height={560} alt="Большая картинка" className="max-w-full h-auto"/> 
                    </div>
                    <div className="w-full md:w-1/2 flex items-center pl-10">
            ...
            <div className="flex mt-10 mb-10">
                <div className="flex flex-col items-center mt-10">
                    ...
                    {Array.from({ length: 4 }).map((_, index) => (
                        ...
                        <Image src={`/services${index + 1}.png`} width={255} height={180} alt={`Картинка ${index + 1}`} className="max-w-full h-auto"/> 
            ...
            <div className="w-full bg-gray-200 p-10 pl-4 pr-4 md:pl-36 md:pr-36 mt-8 flex flex-wrap justify-center gap-4">
                {Array.from({ length: 4 }).map((_, index) => (
                    <div key={index} className="transition duration-500 ease-in-out hover:scale-105 cursor-pointer">
                        <Image src={`/partners${index + 1}.png`} width={255} height={180} alt={`Картинка ${index + 1}`} className="max-w-full h-auto"/> 
                    </div>
                ))}
            </div> 
            <div className="flex flex-col h-[560px]"> 
                <div className="flex justify-between mt-20 gap-x-28 flex-grow">  
                    <div className="flex-shrink-0">   
                        <Image src='/book.png' width={730} height={410} alt="Описание изображения" className="max-w-full h-auto"/>        
                    </div>  
                    <div className="flex justify-center flex-col text-left max-w-md">    
                        <span className="text-6xl text-gray-600 font-light mb-4">Простые вещи <br /> Из бумаги</span>    
                        <span style={{ color: '#85859B', maxWidth: '375px' }}>    
